...
| | Prisma | IlanaORM |
|---|---|---|
| Schema | Separate `.prisma` file | JavaScript class properties |
| Models | Auto-generated client | Hand-written classes |
| Migrations | `prisma migrate dev` | `npx ilana migrate` |
| Relations | Defined in schema | Methods on the class |
| Type safety | Generated types | Hand-authored `.d.ts` |
| Soft deletes | Manual middleware | `static softDeletes = true` |
